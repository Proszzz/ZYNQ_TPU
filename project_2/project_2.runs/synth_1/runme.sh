...
HD_PWD='C:/Users/dell/Desktop/Tensor/project_2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tensor_processing_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tensor_processing_unit.tcl
